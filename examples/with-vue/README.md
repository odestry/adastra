...
```shell
npm create adastra@latest -- --template odestry/adastra/examples/with-vue
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template odestry/adastra/examples/with-vue
# pnpm create adastra@latest --template odestry/adastra/examples/with-vue
```
...
![with-vue](https://raw.githubusercontent.com/odestry/adastra/main/.github/assets/minimal-template-banner.png)
