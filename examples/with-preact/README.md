...
```shell
npm create adastra@latest -- --template odestry/adastra/examples/with-preact
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template odestry/adastra/examples/with-preact
# pnpm create adastra@latest --template odestry/adastra/examples/with-preact
```
...
![with-preact](https://raw.githubusercontent.com/odestry/adastra/main/.github/assets/minimal-template-banner.png)
