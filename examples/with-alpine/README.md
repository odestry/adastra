...
```shell
npm create adastra@latest -- --template blanklob/adastra/examples/with-alpine
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template blanklob/adastra/examples/with-alpine
# pnpm create adastra@latest --template blanklob/adastra/examples/with-alpine
```
