...
```shell
npm create adastra@latest -- --template blanklob/adastra/examples/with-solid
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template blanklob/adastra/examples/with-solid
# pnpm create adastra@latest --template blanklob/adastra/examples/with-solid
```
