# Adastra Example With Solid ✨

```shell
npm create adastra@latest -- --template odestry/adastra/examples/with-solid
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template odestry/adastra/examples/with-solid
# pnpm create adastra@latest --template odestry/adastra/examples/with-solid
```
...
![with-solid](https://raw.githubusercontent.com/odestry/adastra/main/.github/assets/minimal-template-banner.png)
