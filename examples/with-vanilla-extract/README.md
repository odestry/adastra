# Adastra Example With Vanilla Extract ✨

```shell
npm create adastra@latest -- --template odestry/adastra/examples/with-vanilla-extract
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template odestry/adastra/examples/with-vanilla-extract
# pnpm create adastra@latest --template odestry/adastra/examples/with-vanilla-extract
```
...
![with-vanilla-extract](https://raw.githubusercontent.com/odestry/adastra/main/.github/assets/minimal-template-banner.png)
