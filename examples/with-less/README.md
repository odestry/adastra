# Adastra Example With Less ✨

```shell
npm create adastra@latest -- --template odestry/adastra/examples/with-less
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template odestry/adastra/examples/with-less
# pnpm create adastra@latest --template odestry/adastra/examples/with-less
```
...
![with-less](https://raw.githubusercontent.com/odestry/adastra/main/.github/assets/minimal-template-banner.png)
...
Adastra ✨ detects entrypoint files automatically in the `entrypoints/` directory. In this case `base.less` for styles and `index.js` for modules.
