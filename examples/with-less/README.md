...
```shell
npm create adastra@latest -- --template blanklob/adastra/examples/with-less
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template blanklob/adastra/examples/with-less
# pnpm create adastra@latest --template blanklob/adastra/examples/with-less
```
