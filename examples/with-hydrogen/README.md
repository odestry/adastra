# Adastra Example With React Hydrogen ✨

```shell
npm create adastra@latest -- --template blanklob/adastra/examples/with-hydrogen
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template blanklob/adastra/examples/with-hydrogen
# pnpm create adastra@latest --template blanklob/adastra/examples/with-hydrogen
```
...
![with-hydrogen](https://raw.githubusercontent.com/blanklob/adastra/main/.github/assets/minimal-template-banner.png)
