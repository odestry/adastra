...
```shell
npm create adastra@latest -- --template odestry/adastra/examples/with-hydrogen
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template odestry/adastra/examples/with-hydrogen
# pnpm create adastra@latest --template odestry/adastra/examples/with-hydrogen
```
...
![with-hydrogen](https://raw.githubusercontent.com/odestry/adastra/main/.github/assets/minimal-template-banner.png)
