...
```shell
npm create adastra@latest -- --template odestry/adastra/examples/with-lit
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template odestry/adastra/examples/with-lit
# pnpm create adastra@latest --template odestry/adastra/examples/with-lit
```
...
![with-lit](https://raw.githubusercontent.com/odestry/adastra/main/.github/assets/minimal-template-banner.png)
