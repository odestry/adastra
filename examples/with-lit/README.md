...
```shell
npm create adastra@latest -- --template blanklob/adastra/examples/with-lit
```

Using Yarn/PNPM

```bash
yarn create adastra@latest --template blanklob/adastra/examples/with-lit
# pnpm create adastra@latest --template blanklob/adastra/examples/with-lit
```
