...
export function debug (opts: LogOptions, type: string | null, ...messages: any[]): void {
  return log(opts, 'debug', type, ...messages)
}

/** Emit a general info message (be careful using this too much!) */
export function info (opts: LogOptions, type: string | null, ...messages: any[]): void {
  return log(opts, 'info', type, ...messages)
}

/** Emit a warning a user should be aware of */
export function warn (opts: LogOptions, type: string | null, ...messages: any[]): void {
  return log(opts, 'warn', type, ...messages)
}

/** Emit a fatal error message the user should address. */
export function error (opts: LogOptions, type: string | null, ...messages: any[]): void {
