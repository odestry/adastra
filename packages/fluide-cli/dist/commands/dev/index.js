...
export default class Dev extends ThemeCommand {
    constructor() {
        ...
        this.ThemeRefreshTimeoutInMs = 24 * 110 * 60 * 1000;
    }
    /**
...
Dev.description = color.hex(brand.colors.yellowgreen)('Uploads the current theme as a development theme to the connected store, then prints theme editor and preview URLs to your terminal. While running, changes will push to the store in real time.');
Dev.flags = {
    ...globalFlags,
