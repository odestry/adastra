...
export const getAstroVersion = async (): Promise<string> => await new Promise<string>((resolve) => {
...
export const getUserName = async (): Promise<string> => await new Promise<string>((resolve) => {
